...
const Hero = () => {
  ...
  return (
    <section
      className="mt-16 px-6 mx-auto sm:w-[600px] md:w-11/12 lg:w-[870px]"
    ...
    >
      ...
      >
        Creatif Studio Pro enables infrastructure automation for provisioning,
        compliance, and management of any cloud, data center, and service.
      </ProductsSectionDescription>
