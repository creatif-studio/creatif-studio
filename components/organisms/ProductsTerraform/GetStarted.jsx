    ...
    <div className="container mt-44 flex flex-col sm:px-5 md:flex-row md:justify-between lg:px-10">
      <section className="md:w-4/12 lg:w-3/12">
        <ProductsSectionTitle>
          Get started with Creatif Studio Pro
        </ProductsSectionTitle>
      </section>
      <section className="mt-5 md:mt-0 md:w-6/12 lg:w-7/12">
        <ProductsSectionDescription className="text-gray-700 sm:text-lg md:mt-0">
          Get started with Creatif Studio Pro and start collaborating
        </ProductsSectionDescription>
        <section className="flex flex-wrap mt-5">
          <ProductsNavLinkButton
            variant="primary"
            className="py-3 px-4 block bg-purple-700 mr-3"
          >
          ...
          <ProductsNavLink className="mx-3 mt-5 block flex items-center justify-start animate-button-icon relative w-[120px]">
            ...
            <BsArrowRightShort
              size={26}
              className="block transition-all icon absolute right-0"
            />
          </ProductsNavLink>
        ...
        <section className="border border-gray-300 p-5 mt-10 text-sm text-gray-800 sm:text-base">
          <p>
            For larger organizations, learn more about the{" "}
            <ProductsNavLink className="text-purple-600 sm:text-base">
              Creatif Studio Pro Business
            </ProductsNavLink>{" "}
            tier
          </p>
        </section>
