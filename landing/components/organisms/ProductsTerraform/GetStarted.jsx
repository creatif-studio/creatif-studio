    ...
    return (
        <div className="container mt-44 flex flex-col sm:px-5 md:flex-row md:justify-between lg:px-10">
            <section className='md:w-4/12 lg:w-3/12'>
                <ProductsSectionTitle>Get started with Terraform Cloud</ProductsSectionTitle>
            </section>
            <section className='mt-5 md:mt-0 md:w-6/12 lg:w-7/12'>
                <ProductsSectionDescription className="text-gray-700 sm:text-lg md:mt-0">Get started with Terraform Cloud and start collaborating</ProductsSectionDescription>
                ...
                <section className="border border-gray-300 p-5 mt-10 text-sm text-gray-800 sm:text-base">
                    <p>For larger organizations, learn more about the <ProductsNavLink className="text-purple-600 sm:text-base">Terraform Cloud Business</ProductsNavLink> tier</p>
                </section>
            </section>
        </div>
    )
