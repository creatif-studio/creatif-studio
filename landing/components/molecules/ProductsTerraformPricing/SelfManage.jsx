...
const SelfManage = () => {
    return (
        <section className="border border-gray-200 p-3 py-8 items-center grid grid-cols-1 justify-between mt-10 xl:grid-cols-12">
            ...
            <p className='text-sm tracking-wide text-center my-5 leading-loose xl:leading-normal xl:my-0 xl:col-span-7'>Terraform Enterprise is a private install for organizations who prefer to self-manage</p>
