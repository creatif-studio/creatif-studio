...
const StoriesCard = ({ href = "/", src = "", header = "Header" }) => {
  return (
    <Link href={href}>
      <a>
        <Card className="col-span-1 border-0 h-96 lg:h-full rounded-md bg-white relative overflow-hidden group">
          <img
            src={src}
            alt="stories"
          ...
          <div className="absolute top-0 right-0 left-0 h-full w-full bg-gradient-to-b from-transparent to-black/40 ease-in flex items-end p-8">
            <h3 className="font-semibold font-display text-2xl text-white">
              {header}
            </h3>
          </div>
        </Card>
