...
const TerraformCloudCard = () => {
  return (
    <Card className="col-span-1 shadow bg-white border-neutral-200 h-full py-8 px-8 xl:max-w-sm cursor-default opacity-0 animate-[move-to-top_0.5s_forwards_0.5s]">
